                        ...
                        case "moving":
                            if(statusArray !== null)
                            {
                                $.each( statusArray, function( file, array) {
                                    ...
                                    data["moving"].push( "  <td>" + array["filedir"] + "</td>" );
                                    data["moving"].push( "  <td>" + array["filesize"] + "</td>");
                                    data["moving"].push( "  <td>" + array["GDSA"] + "</td>" );
                                    data["moving"].push( "  <td>/mnt/pgblitz/" + array["GDSA"] + array["filedir"] + "</td>" );
                                    data["moving"].push( "</tr>" );
                                });
                                ...
                                data["moving"].push( "<tr>" );
                                data["moving"].push( "  <td class=\"text-muted\" colspan=\"5\">No entries found.</td>");
                                data["moving"].push( "</tr>" );
                            }
                            break;
                        case "uploading":
